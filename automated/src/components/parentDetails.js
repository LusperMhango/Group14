...
<h4 className='text-center text-gray-600 '>2ND: ENTER PARENTS DETAILS</h4>
        ...
        <form className="space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full p-1 border border-yellow-800 bg-gray-300 rounded-lg focus:outline-none"
              required/>
          </div>
          <div>
            <input
          ...
          <div className="flex justify-between mt-6">
            <button
              type="button"
              className="bg-orange-500 text-gray-950 font-semibold py-1 px-6 rounded-lg hover:bg-yellow-800 transition"onClick={() => navigate('/personal-details')}
            >
              Previous
            </button>
            <button
              type="submit"
              className="bg-orange-500 text-gray-950 font-semibold py-1 px-6 rounded-lg hover:bg-yellow-800 transition" onClick={() => navigate('/bank-details')}
            >
              Next
            </button>
          </div>
