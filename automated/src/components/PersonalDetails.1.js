      ...
      <div className="w-full h-screen p-8 bg-gray-300 shadow-lg rounded-lg mt-16">
        ...
        <div className="flex justify-center items-center font-sans mt-2">
          <form onSubmit={handleSubmit} className="space-y-4">
            <label className="font-sans mb-4"><b>Firstname:</b>
              <input
                type="text"
                name="firstname"
            ...
            <label className="font-sans mb-4"><b>Surname:</b>
              <input
                type="text"
                name="surname"
                placeholder="Surname"
            ...
            <label className="font-sans mb-4"><b>Gender:</b>
              <select
                name="sex"
                value={formData.sex}
                onChange={handleInputChange}
            ...
            <label className="font-sans mb-4"><b>phone Number:</b>
              <input
                type="tel"
                name="phoneNumber"
            ...
            <label className="font-sans mb-4"><b>home Village:</b>
              <input
                type="text"
                name="homeVillage"
              ...
              <label className="font-sans mb-4"><b>Traditional Authority:</b>
              <input
                type="text"
                name="ta"
                placeholder="T/A"
              ...
              <label className="font-sans mb-4"><b>NationalID:</b>
              <input
                type="text"
                name="nationalId"
